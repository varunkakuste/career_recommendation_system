         ...
         <div id="page-wrapper">
	            ...
	            <div class="row">
	            	<div align="center">
	            		<div class="col-md-6">
			            	...
			            	<button type="button" id="savebutton"class="btn btn-success btn-md"  onclick="javascript: saveJob();">Save</button>
			            </div>
					</div>
	            </div>
	            </form:form>
            ...
            <c:if test="${empty jobList}">
            	<div class="row">
            		...
            		<h4 align="center"><font color="red">No Jobs Recommended...</font></h4>
            	</div>
            </c:if>
         </div>
      </div>
